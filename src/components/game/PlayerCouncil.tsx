          ...
          return (
            <div key={player.id} className="relative flex flex-col items-center">
              ...
              <motion.button
                ...
                className={`relative flex w-full lg:w-28 flex-col items-center gap-0.5 md:gap-1 lg:gap-2 rounded-lg border p-1.5 md:p-2 lg:p-3 transition-all ${
                  !player.is_alive
                    ? 'border-accent/20 bg-card/40 lg:opacity-40 lg:grayscale'
                    : isHerald
              ...
              >
                ...
                {isHerald && (
                  <span className="text-[8px] md:text-[9px] lg:text-xs uppercase tracking-wider text-primary font-display">Herald</span>
                )}
                {isLC && (
                  <span className="text-[8px] md:text-[9px] lg:text-xs uppercase tracking-wider text-accent-foreground font-display">Commander</span>
                )}
              </motion.button>
